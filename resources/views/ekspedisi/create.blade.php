              ...
              <div class="row">
                <div class="col-4">
                  <div class="form-group">
                    ...
                    <input type="text" name="nama" id="nama" class="form-control" placeholder="Masukkan nama pengiriman" required>
                  </div>
                </div>
                <div class="col-4">
                  <div class="form-group">
                    <label for="harga">Harga</label>
                    <input type="text" name="harga" id="harga" class="form-control" placeholder="Masukkan harga pengiriman" required>
                  </div>
                </div>
                <div class="col-4">
                  <div class="form-group">
