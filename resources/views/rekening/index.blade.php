      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header border-transparent">
            <a href="{{ route('rekening.create') }}" class="btn btn-primary btn-sm" style="width: 40px;"><i class="fa fa-plus"></i></a>
          </div>
          <!-- /.card-header -->
                ...
                <tbody>
                  @foreach ($rekening as $key => $item)
                    <tr>
                      ...
                      <td><img src="{{ asset('img_rekening/' . $item->gambar) }}" alt="" style="max-width: 100px;"></td>
                      <td>{{ $item->grup }}</td>
                      <td>
                        <a href="{{ route('rekening.edit', [$item->id]) }}" class="btn btn-primary btn-sm" style="width: 40px;"><i class="fa fa-edit"></i></a>
